...
import gupaoedu.domain.Blog;
import gupaoedu.domain.associate.AuthorAndBlog;
import gupaoedu.domain.associate.BlogAndAuthor;
import gupaoedu.domain.associate.BlogAndComment;
import gupaoedu.mapper.BlogMapper;
import gupaoedu.mapper.BlogMapperExt;
...
public class MyBatisTest {
    ...
    public void testStatement() throws IOException {
        ...
        try {
            Blog blog = (Blog) session.selectOne("gupaoedu.mapper.BlogMapper.selectBlogById", 1);
